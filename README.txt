...
If you want to use mask detection with the webcam, just open the MaskTespit-PcWebcam.py file.
...
For detailed Opencv application with phone camera:".........."
...
Then just run the MaskDetection_TelephoneCamera_Tr.py file.
Note: 
